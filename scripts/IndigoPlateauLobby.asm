...
IndigoPlateauLobbyClerkText:						                 ; New text added by G-Dubs (Followed tutorial to free up space in the home bank)
	...
	script_mart POKE_BALL, GREAT_BALL, ULTRA_BALL, POTION, SUPER_POTION, HYPER_POTION, MAX_POTION, FULL_RESTORE, REVIVE, ANTIDOTE, PARALYZE_HEAL, BURN_HEAL, AWAKENING, ICE_HEAL, FULL_HEAL, ESCAPE_ROPE, REPEL, SUPER_REPEL, MAX_REPEL
