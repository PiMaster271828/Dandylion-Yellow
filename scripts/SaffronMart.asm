...
.CascadeStock
	...
	script_mart POKE_BALL, GREAT_BALL, POTION, SUPER_POTION, ESCAPE_ROPE, REPEL, SUPER_REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARALYZE_HEAL, ICE_HEAL
	ret

.RainbowStock
	; Inventory for 4-5 Badges 
	script_mart POKE_BALL, GREAT_BALL, POTION, SUPER_POTION, HYPER_POTION, REVIVE, ESCAPE_ROPE, REPEL, SUPER_REPEL, MAX_REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARALYZE_HEAL, ICE_HEAL, FULL_HEAL
	ret
