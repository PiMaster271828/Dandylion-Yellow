...
SaffronMartClerkText:					                             ; New text added by G-Dubs (Followed tutorial to free up space in the home bank)
	script_mart POKE_BALL, GREAT_BALL, POTION, SUPER_POTION, HYPER_POTION, REVIVE, ANTIDOTE, PARALYZE_HEAL, BURN_HEAL, AWAKENING, ICE_HEAL, FULL_HEAL, ESCAPE_ROPE, REPEL, SUPER_REPEL, MAX_REPEL
...
.CascadeStock
	...
	script_mart POKE_BALL, GREAT_BALL, POTION, SUPER_POTION, ANTIDOTE, PARALYZE_HEAL, BURN_HEAL, AWAKENING, ICE_HEAL, ESCAPE_ROPE, REPEL, SUPER_REPEL
	ret
