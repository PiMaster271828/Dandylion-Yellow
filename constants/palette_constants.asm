...
; SuperPalettes indexes (see data/sgb/sgb_palettes.asm)
	...
	const PAL_PIKACHUS_BEACH       ; $29
	const PAL_PIKACHU_PORTRAIT     ; $2A
	const PAL_PIKACHUS_BEACH_TITLE ; $2B
