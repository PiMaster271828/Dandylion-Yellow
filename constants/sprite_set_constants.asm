...
; values for MapSpriteSets and SplitMapSpriteSets (see data/maps/sprite_sets.asm)
	const_def 1
	const SPRITESET_PALLET_VIRIDIAN    ; 1
	const SPRITESET_PEWTER_CITY        ; 2
	const SPRITESET_CERULEAN_CITY      ; 3
	const SPRITESET_LAVENDER_TOWN      ; 4
	const SPRITESET_VERMILION_CITY     ; 5
	const SPRITESET_CELADON_CITY       ; 6
	const SPRITESET_INDIGO_PLATEAU     ; 7
	const SPRITESET_SAFFRON_CITY       ; 8
	const SPRITESET_SILENCE_BRIDGE     ; 9
	const SPRITESET_CYCLING_ROAD       ; A
	const SPRITESET_FUCHSIA_CITY       ; B
	const SPRITESET_CINNABAR_ISLAND    ; C
	const SPRITESET_ROUTE_5            ; D  ; New sprite set added by G-Dubs
	const SPRITESET_ROUTE_7            ; E  ; New sprite set added by G-Dubs
	const SPRITESET_FUCHSIA_CITY_ZOO   ; B  ; New sprite set added by G-Dubs
