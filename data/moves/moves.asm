...
; Characteristics of each move.
	...
	move PAY_DAY,      PAY_DAY_EFFECT,              40, NORMAL,       100, 20                                                                        ; Move #6
	...
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5                                                                        ; Move #12
	...
	move TWINEEDLE,    TWINEEDLE_EFFECT,            40, BUG,          100, 20 ; Buffed power                                                         ; Move #41
	...
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,  120, GRASS,        100, 20 ; Buffed power                                                         ; Move #80
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, BUG,          100, 40                                                                        ; Move #81
	...
	move LIGHT_SCREEN, LIGHT_SCREEN_EFFECT,          0, PSYCHIC_TYPE, 100, 30                                                                        ; Move #113
	...
	move BONE_CLUB,    FLINCH_SIDE_EFFECT1,         70, GROUND,        90, 20 ; Buffed power & accuracy                                              ; Move #125
	...
	move KINESIS,      ACCURACY_DOWN1_EFFECT,        0, PSYCHIC_TYPE,  95, 15 ; Buffed accuracy                                                      ; Move #134
	move SOFTBOILED,   HEAL_EFFECT,                  0, NORMAL,       100, 10                                                                        ; Move #135
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           130, FIGHTING,      90, 20 ; Buffed power                                                         ; Move #136
	...
	move POISON_GAS,   POISON_EFFECT,                0, POISON,        85, 40 ; Buffed accuracy                                                      ; Move #139
	...
	move DIZZY_PUNCH,  NO_ADDITIONAL_EFFECT,        70, FIGHTING,     100, 10 ; Changed to Fighting type                                             ; Move #146
	...
	move SPLASH,       SPLASH_EFFECT,                0, WATER,         10, 40 ; Nerfed accuracy (Move too strong, please nerf!)                      ; Move #150
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,       100, 40                                                                        ; Move #151
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,        90, WATER,         95, 10 ; Gave flinch side effect, & buffed power & accuracy                   ; Move #152
	...
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         50, GROUND,        90, 10                                                                        ; Move #155
...
; Unadded moves
	move TOMBSTONER,    POISON_SIDE_EFFECT1,         70, GHOST,         75, 15                                                                       ; Move #165
	...
	move AERIAL_ACE,    SWIFT_EFFECT,                60, FLYING,       100, 20                                                                       ; Move #168
	move GIGA_IMPACT,   HYPER_BEAM_EFFECT,          150, NORMAL,        90,  5                                                                       ; Move #169
	move CRUNCH,        CRUNCH_EFFECT,               80, DARK,         100, 15 ; 30% Lower opponent's defense, 30% Flinch                            ; Move #170
	move FAINT_ATTACK,  SWIFT_EFFECT,                60, DARK,         100, 20                                                                       ; Move #171
	move MAGNET_BOMB,   SWIFT_EFFECT,                60, STEEL,        100, 20                                                                       ; Move #172
	...
	move SWEET_KISS,    CONFUSION_EFFECT,             0, FAIRY,         85, 10                                                                       ; Move #180
    move SPARK,         PARALYZE_SIDE_EFFECT2,       65, ELECTRIC,     100, 25                                                                       ; Move #181
    move MACH_PUNCH,    NO_ADDITIONAL_EFFECT,        40, FIGHTING,     100, 30 ; Priority +1                                                         ; Move #182
    move POISON_FANG,   POISON_FANG_EFFECT,          50, POISON,       100, 15 ; 50% Badly Poison, 10% Flinch                                        ; Move #183
    move POISON_TAIL,   POISON_TAIL_SIDE_EFFECT,     50, POISON,       100, 15 ; 10% Badly Poison, high Crit. rate                                   ; Move #184
   ;move ZIPPY_ZAP,     ZIPPY_ZAP_EFFECT,            50, ELECTRIC,     100, 15 ; Priority +3, Always Crit., Raise user's Evasion                     ; Move #185
   ;move PIKA_PAPOW,    PIKA_PAPOW_EFFECT,            1, ELECTRIC,     100,  5 ; Priority +4, Always hit, Always Crit., Power based on Pikachu's friendship (Default power of 250 if used by another Pokémon)
    move FRENZY_PLANT,  HYPER_BEAM_EFFECT,          150, GRASS,         90,  5                                                                       ; Move #186
    move BLAST_BURN,    HYPER_BEAM_EFFECT,          150, FIRE,          90,  5                                                                       ; Move #187
    move HYDRO_CANNON,  HYPER_BEAM_EFFECT,          150, WATER,         90,  5                                                                       ; Move #188
  	move BOUNCE,        FLY_EFFECT,                  85, FLYING,        85, 15 ; 30% Paralyze on landing turn                                        ; Move #189
   ...
   ;move FIREY_WRATH,   FIREY_WRATH_SIDE_EFFECT,     90, DARK,         100, 10 ; 10% Burn, 10% Flinch
    ...
    move EXTREMESPEED,  EXTREMESPEED_EFFECT,         80, NORMAL,       100, 10 ; Priority +2                                                         ; Move #200
    move SACRED_FIRE,   SACRED_FIRE_EFFECT,         100, FIRE,          95,  5 ; 50% Burn                                                            ; Move #201
    move ANCIENTPOWER,	ANCIENT_POWER_EFFECT,        60, ROCK,         100, 10 ; 10% Omniboost                                                       ; Move #202
	move FIN_SLAP,      ATTACK_TWICE_EFFECT,         20, WATER,         10, 30                                                                       ; Move #203
    move BUG_BITE,      FLINCH_SIDE_EFFECT2,         60, BUG,          100, 20                                                                       ; Move #204
    move SHADOW_BONE    SPECIAL_DOWN_SIDE_EFFECT,    85, GHOST,        100, 10                                                                       ; Move #205
    move KINDLE	        BURN_SIDE_EFFECT1,           20, FIRE,         100, 30                                                                       ; Move #206
	move DRAGONBREATH,  PARALYZE_SIDE_EFFECT1,       60, DRAGON,       100, 20                                                                       ; Move #207
	move PSY-KICK,      FLINCH_SIDE_EFFECT2,         75, PSYCHIC_TYPE, 100, 15                                                                       ; Move #208
   ;move PSYSHOCK,      SWIFT_EFFECT,                95, PSYCHIC_TYPE, 100, 15                                                                       ; Move #209
   ;move PSYSTRIKE,     SPECIAL_DOWN_SIDE_EFFECT,   100, PSYCHIC_TYPE, 100, 15                                                                       ; Move #210
    move MUD_SHOT,      AUTO_SPEED_DOWN_SIDE_EFFECT, 55, GROUND,        95, 15 ; Always lower's opponent's Speed                                     ; Move #211
    move MUD-SLAP,      AUTO_ACC_DOWN_SIDE_EFFECT,   20, GROUND,       100, 10 ; Always lower's opponent's Accuracy                                  ; Move #212
    move MUD_BOMB,      ACCURACY_DOWN_SIDE_EFFECT2,  65, GROUND,        95, 10 ; Lowers opponent's Accuracy 30%                                      ; Move #213
    move WHIRLPOOL,     TRAPPING_EFFECT,             20, WATER,         85, 20                                                                       ; Move #214
    move DIVE_BOMB,     JUMP_KICK_EFFECT,            90, FLYING,	    90, 10 ; Fixed Jump Kick Effect                                              ; Move #215
	move GIGA_DRAIN,    DRAIN_HP_EFFECT,             80, GRASS,        100, 10                                                                       ; Move #216
	move LEAFAGE,       NO_ADDITIONAL_EFFECT,        20, GRASS,        100, 30                                                                       ; Move #217
	move ROCK_SMASH,    DEFENSE_DOWN_SIDE_EFFECT,    20, FIGHTING,     100, 30                                                                       ; Move #218
	move SEED_BOMB,     NO_ADDITIONAL_EFFECT,        80, GRASS,        100, 15                                                                       ; Move #219
	move CROSS_CHOP,    NO_ADDITIONAL_EFFECT,        85, FIGHTING,      85, 10 ; High Crit. rate                                                     ; Move #220
	move OCTAZOOKA,     ACCURACY_DOWN_SIDE_EFFECT3   65, WATER,         95, 10 ; Lowers opponent's Accuracy 50%                                      ; Move #221
   ...
   ;move SPIN_SLASH,    NO_ADDITIONAL_EFFECT,        55, NORMAL,        95, 30 ; High Crit. rate                                                     ; Move #229
	move ROCK_BLAST,    TWO_TO_FIVE_ATTACKS_EFFECT,  25, ROCK,          90, 20                                                                       ; Move #230
	move ROCK_TOMB,     SPEED_DOWN_SIDE_EFFECT,      50, ROCK,          90, 10 ; Always lower's opponent's Speed                                     ; Move #231
	move MEGAHORN,      FLINCH_SIDE_EFFECT2,        120, BUG,           85, 10                                                                       ; Move #232
	move PLAY_ROUGH,    ATTACK_DOWN_SIDE_EFFECT,     90, FAIRY,         90, 10                                                                       ; Move #233
	move SNIPE_SHOT,    NO_ADDITIONAL_EFFECT,        80, WATER,        100, 15 ; High Crit. rate                                                     ; Move #234
	move SKY_UPPERCUT,  NO_ADDITIONAL_EFFECT,        85, FIGHTING,      95, 15 ; Can hit Pokémon in sky                                              ; Move #235
	move SHADOW_CLAW,   NO_ADDITIONAL_EFFECT,        70, GHOST,        100, 15 ; High Crit. rate                                                     ; Move #236
	move SHADOW_PUNCH,  SWIFT_EFFECT,                60, GHOST,        100, 20                                                                       ; Move #237
	move MIRROR_COAT,   MIRROR_COAT_EFFECT,           1, PSYCHIC_TYPE, 100, 20 ; Modern Mirror Coat Effect                                           ; Move #238
	move POISON_JAB,    POISON_SIDE_EFFECT1,         80, POISON,       100, 20                                                                       ; Move #239
	move VOLT_TACKLE,   RECOIL_EFFECT,              120, ELECTRIC,     100, 15                                                                       ; Move #240
	move SHEER_COLD,    OHKO_EFFECT,                  1, ICE,           30,  5                                                                       ; Move #241
	move SHOCK_WAVE,    SWIFT_EFFECT,                60, ELECTRIC,     100, 20                                                                       ; Move #242
	move ICY_WIND,      AUTO_SPEED_DOWN_SIDE_EFFECT, 55, ICE,           95, 15 ; Always lower's opponent's Speed                                     ; Move #243
    move WILD_CHARGE,   RECOIL_EFFECT,               90, ELECTRIC,      90, 20 ; 20% Paralyze, in addition to the Recoil Effect                      ; Move #244
   ...
   ;move NUZZLE,        AUTO_PARALYZE_SIDE_EFFECT,   20, ELECTRIC,     100, 20 ; Always paralyzes opponent
	...
	move DRAGON_CLAW,   NO_ADDITIONAL_EFFECT,        70, DRAGON,       100, 15 ; High Crit. rate                                                     ; Move #250
	move SLUDGE_WAVE,   POISON_SIDE_EFFECT2,        120, POISON,        85, 10                                                                       ; Move #251
	move BUG_BUZZ,	    SPECIAL_DOWN_SIDE_EFFECT,    90, BUG,          100, 10                                                                       ; Move #252
	move HEAD_SMASH,    RECOIL_EFFECT,              150, ROCK,          80,  5                                                                       ; Move #253
	move EARTH_POWER,   SPECIAL_DOWN_SIDE_EFFECT,    90, GROUND,       100, 10                                                                       ; Move #254
	move SIGNAL_BEAM,   CONFUSION_SIDE_EFFECT,       75, BUG,          100, 15                                                                       ; Move #255 
	move THUNDERSTRIKE, PARALYZE_SIDE_EFFECT1,      120, ELECTRIC,      85, 10                                                                       ; Move #256
	move GNAW,          FLINCH_SIDE_EFFECT2,         60, NORMAL,       100, 25                                                                       ; Move #257
	move BLAZE_KICK,    BURN_SIDE_EFFECT1,           85, FIRE,          95, 10 ; High Crit. rate                                                     ; Move #258
	
; Unanimated moves
	move PSYCHIC_ARMOR, DEFENSE_UP2_EFFECT,           0, PSYCHIC_TYPE, 100, 40                                                                       ; Move #259
	move RADAR_EYES,    EVASION_DOWN_SIDE_EFFECT,    35, BUG,          100, 20 ; This move can't miss, and always lowers the foe's evasion           ; Move #260
	move RAZOR_SHELL,   DEFENSE_DOWN_SIDE_EFFECT,    75, WATER,         95, 10 ; High Crit. rate                                                     ; Move #261

	move STRUGGLE,      RECOIL_EFFECT,               50, STRUGGLE,     100, 10                                                                       ; Move #262
	assert_table_length NUM_ATTACKS
*/
