...
; Characteristics of each move.
	...
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        95, 10
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  20, FIGHTING,      95, 15
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        90, FIGHTING,      95, 20
	...
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         75, FIGHTING,      95, 15
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, GROUND,       100, 15
	move HEADBUTT,     FLINCH_SIDE_EFFECT2,         70, NORMAL,       100, 15
	move HORN_ATTACK,  NO_ADDITIONAL_EFFECT,        65, BUG,          100, 25
	move FURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,        95, 20
	...
	move LOW_KICK,     FLINCH_SIDE_EFFECT2,         55, FIGHTING,     100, 20
	...
	move CONFUSION,    CONFUSION_SIDE_EFFECT,       65, PSYCHIC_TYPE, 100, 25
	...
	move RAGE,         RAGE_EFFECT,                 80, NORMAL,       100, 20
	...
	move SMOG,         POISON_SIDE_EFFECT2,         40, POISON,        95, 20
	...
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  35, WATER,        100, 15
	...
	move SPLASH,       SPLASH_EFFECT,                0, WATER,         10, 40
