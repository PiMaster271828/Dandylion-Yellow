...
ViridianCity_Object:
	...
	warp_event 31, 19, VIRIDIAN_MART, 1
	...
	bg_event 32, 19, TEXT_VIRIDIANCITY_MART_SIGN
	...
	object_event 31, 20, SPRITE_OFFICER_JENNY, STAY, NONE, TEXT_VIRIDIANCITY_OFFICER_JENNY
