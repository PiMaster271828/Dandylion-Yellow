	...
	const_export VIRIDIANCITY_OFFICER_JENNY
...
ViridianCity_Object:
	...
	warp_event 33, 19, VIRIDIAN_MART, 1
	...
	bg_event 19,  3, TEXT_VIRIDIANCITY_TRAINER_TIPS1
	bg_event 21, 29, TEXT_VIRIDIANCITY_TRAINER_TIPS2
	bg_event 34, 19, TEXT_VIRIDIANCITY_MART_SIGN
	bg_event 22, 25, TEXT_VIRIDIANCITY_POKECENTER_SIGN
	bg_event 27,  7, TEXT_VIRIDIANCITY_GYM_SIGN
	bg_event 21, 17, TEXT_VIRIDIANCITY_SCHOOLHOUSE_SIGN    ; New sign added by G-Dubs

	def_object_events
	object_event 13, 20, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER1
	object_event 31,  8, SPRITE_GAMBLER, STAY, NONE, TEXT_VIRIDIANCITY_GAMBLER1
	...
	object_event 33, 20, SPRITE_OFFICER_JENNY, STAY, NONE, TEXT_VIRIDIANCITY_OFFICER_JENNY    ; Officer Jenny added by Vlad
