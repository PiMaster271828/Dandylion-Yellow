...
ViridianSchoolHouse_Object:
    ...
    object_event  0,  4, SPRITE_LITTLE_BOY, STAY, RIGHT, TEXT_VIRIDIANSCHOOLHOUSE_LITTLE_BOY1, OPP_SCHOOL_KID, 4            ; New trainer added by G-Dubs
	...
	object_event  0,  2, SPRITE_LITTLE_BOY, STAY, RIGHT, TEXT_VIRIDIANSCHOOLHOUSE_LITTLE_BOY2, OPP_SCHOOL_KID, 5            ; New trainer added by G-Dubs
