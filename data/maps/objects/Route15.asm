...
Route15_Object:
	...
	def_warp_events
	warp_event  5, 12, ROUTE_15_GATE_1F, 1
	warp_event  5, 13, ROUTE_15_GATE_1F, 1
	warp_event 12, 12, ROUTE_15_GATE_1F, 3
	warp_event 12, 13, ROUTE_15_GATE_1F, 3
	...
	object_event 30, 14, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE15_COOLTRAINER_M1, OPP_BIRD_KEEPER, 6
	object_event 35, 14, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE15_COOLTRAINER_M2, OPP_BIRD_KEEPER, 7
	...
	object_event 49, 10, SPRITE_BIKER, STAY, DOWN, TEXT_ROUTE15_BIKER1, OPP_BIKER, 3
	object_event 48, 10, SPRITE_BIKER, STAY, DOWN, TEXT_ROUTE15_BIKER2, OPP_BIKER, 4
	object_event 39,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE15_COOLTRAINER_F3, OPP_JR_TRAINER_F, 22
	object_event 18, 14, SPRITE_COOLTRAINER_F, STAY, UP, TEXT_ROUTE15_COOLTRAINER_F4, OPP_JR_TRAINER_F, 23
