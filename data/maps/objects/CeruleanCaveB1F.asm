...
CeruleanCaveB1F_Object:
	...
	object_event 21, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_ULTRA_BALL2, ULTRA_BALL
	object_event 20,  1, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_MAX_REVIVE, MAX_REVIVE
