...
VermilionCity_Object:
	...
	warp_event 13, 19, VERMILION_GYM, 1
	warp_event 23, 19, VERMILION_PIDGEY_HOUSE, 1
	warp_event 20, 32, VERMILION_DOCK, 1
	warp_event 21, 32, VERMILION_DOCK, 1
	warp_event 15, 13, VERMILION_TRADE_HOUSE, 1
	warp_event  7,  3, VERMILION_OLD_ROD_HOUSE, 1

	def_bg_events
	bg_event 29,  3, TEXT_VERMILIONCITY_SIGN
	bg_event 35, 13, TEXT_VERMILIONCITY_NOTICE_SIGN
	...
	bg_event 31, 16, TEXT_VERMILIONCITY_HARBOR_SIGN
	bg_event 41, 13, TEXT_VERMILIONCITY_DIGLETTS_CAVE_SIGN           ; New sign added by G-Dubs
	bg_event 34, 16, TEXT_VERMILIONCITY_FISHING_NOTICE_SIGN          ; New sign added by G-Dubs
	...
	object_event 21, 31, SPRITE_SAILOR, STAY, UP, TEXT_VERMILIONCITY_SAILOR1
	...
	object_event 27, 27, SPRITE_SAILOR, WALK, LEFT_RIGHT, TEXT_VERMILIONCITY_SAILOR2
