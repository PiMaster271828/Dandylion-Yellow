...
VermilionCity_Object:
	...
	warp_event 18, 32, VERMILION_DOCK, 1
	warp_event 19, 32, VERMILION_DOCK, 1
	...
	bg_event 29, 16, TEXT_VERMILIONCITY_HARBOR_SIGN
	bg_event 39, 13, TEXT_VERMILIONCITY_DIGLETTS_CAVE_SIGN           ; New sign added by G-Dubs
	bg_event 32, 16, TEXT_VERMILIONCITY_FISHING_NOTICE_SIGN          ; New sign added by G-Dubs
	...
	object_event 19, 31, SPRITE_SAILOR, STAY, UP, TEXT_VERMILIONCITY_SAILOR1
