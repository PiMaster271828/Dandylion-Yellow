	object_const_def
	const_export MTMOON1F_HIKER1            ; Hiker renamed to Hiker1 by G-Dubs
   ...
   ;const_export MTMOON1F_POTION2           ; Moving Potion to another location
...
MtMoon1F_Object:
	...
	def_warp_events
	warp_event 14, 35, LAST_MAP, 2     ; Warp Event 1
	warp_event 15, 35, LAST_MAP, 2     ; Warp Event 2
	warp_event  5,  5, MT_MOON_B1F, 1  ; Warp Event 3
	warp_event 17, 11, MT_MOON_B1F, 3  ; Warp Event 4
	warp_event 25, 15, MT_MOON_B1F, 4  ; Warp Event 5

	def_bg_events
	bg_event 15, 23, TEXT_MTMOON1F_BEWARE_ZUBAT_SIGN

	def_object_events
	object_event  5,  6, SPRITE_HIKER, STAY, DOWN, TEXT_MTMOON1F_HIKER1, OPP_HIKER, 1                   ; Hiker renamed to Hiker1 by G-Dubs
