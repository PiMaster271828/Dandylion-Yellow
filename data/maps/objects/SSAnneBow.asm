...
SSAnneBow_Object:
	...
	def_warp_events
	warp_event 17,  6, SS_ANNE_3F, 1
	warp_event 17,  7, SS_ANNE_3F, 1

	def_bg_events

	def_object_events
	object_event  7, 11, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_SSANNEBOW_COOLTRAINER_M
	object_event 13, 11, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_SSANNEBOW_COOLTRAINER_F            ; NPC added by G-Dubs
	object_event  5,  2, SPRITE_SUPER_NERD, STAY, UP, TEXT_SSANNEBOW_SUPER_NERD, OPP_POKEMANIAC, 9 ; NPC changed to trainer by G-Dubs
	object_event  8,  4, SPRITE_SAILOR, STAY, DOWN, TEXT_SSANNEBOW_SAILOR1, OPP_SAILOR, 9          ; NPC changed to trainer by G-Dubs
	...
	object_event 14,  2, SPRITE_SAILOR, STAY, DOWN, TEXT_SSANNEBOW_SAILOR4, OPP_SAILOR, 7 	       ; New trainer added by G-Dubs
