	...
	const_export VIRIDIANFOREST_YOUNGSTER7
	const_export VIRIDIANFOREST_YOUNGSTER8
	const_export VIRIDIANFOREST_YOUNGSTER9
	const_export VIRIDIANFOREST_YOUNGSTER10
...
ViridianForest_Object:
	...
	object_event  9, 32, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER7, OPP_BUG_CATCHER, 16
