...
SSAnne1FRooms_Object:
	...
	object_event 21, 13, SPRITE_GENTLEMAN, STAY, RIGHT, TEXT_SSANNE1FROOMS_GENTLEMAN3, OPP_GENTLEMAN, 6      ; NPC changed to trainer added by G-Dubs
	object_event 22,  3, SPRITE_GIRL, STAY, UP, TEXT_SSANNE1FROOMS_GIRL1, OPP_LADY, 2                        ; NPC changed to trainer added by G-Dubs
