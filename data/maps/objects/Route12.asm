...
Route12_Object:
	...
	object_event 14, 27, SPRITE_FISHER, STAY, LEFT, TEXT_ROUTE12_FISHER1, OPP_FISHER, 3
	...
	object_event 14, 75, SPRITE_SUPER_NERD, STAY, UP, TEXT_ROUTE12_SUPER_NERD1, OPP_ROCKER, 2
