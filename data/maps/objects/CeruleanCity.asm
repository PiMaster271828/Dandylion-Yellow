...
CeruleanCity_Object:
	...
	def_warp_events
	warp_event 28, 11, CERULEAN_TRASHED_HOUSE, 1
	...
	warp_event 10, 11, CERULEAN_BADGE_HOUSE, 2
	...
	object_event 14, 20, SPRITE_SUPER_NERD, WALK, UP_DOWN, TEXT_CERULEANCITY_SUPER_NERD1
	object_event  8, 20, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_CERULEANCITY_SUPER_NERD2
	object_event 29, 12, SPRITE_OFFICER_JENNY, STAY, DOWN, TEXT_CERULEANCITY_GUARD1
