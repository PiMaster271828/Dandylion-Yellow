...
MapSpriteSets:
	...
	db SPRITESET_VERMILION       ; ROUTE_6
	db SPRITESET_ROUTE_7         ; ROUTE_7
	db SPRITESET_LAVENDER        ; ROUTE_8
...
SplitMapSpriteSets:
    ...
    db NORTH_SOUTH, 21, SPRITESET_LAVENDER,        SPRITESET_SILENCE_BRIDGE  ; SPLITSET_ROUTE_12   ; Now unused (Route 12 uses Silence Bridge) Changed by G-Dubs 
	...
	db EAST_WEST,   53, SPRITESET_CINNABAR_ISLAND, SPRITESET_FUCHSIA         ; SPLITSET_ROUTE_20
   ;db NORTH_SOUTH, 33, SPRITESET_NEW_SPRITE_SET,  SPRITESET_SAFFRON         ; SPLITSET_ROUTE_5    ; Changed Route 5's Northern Sprite Set
