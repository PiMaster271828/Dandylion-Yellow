...
ViridianCityHS:
	...
	db VIRIDIAN_CITY, VIRIDIANCITY_OFFICER_JENNY,  SHOW    ; New hide/show data added by Vlad
PewterCityHS:
...
ViridianPokecenterHS:
	db VIRIDIAN_POKECENTER, VIRIDIANPOKECENTER_JESSIE, HIDE     ; New hide/show data added by Vlad
	db VIRIDIAN_POKECENTER, VIRIDIANPOKECENTER_JAMES,  HIDE     ; New hide/show data added by Vlad
ViridianGymHS:
...
PokemonTower7FHS:
	...
	db POKEMON_TOWER_7F, POKEMONTOWER7F_ROCKET1, SHOW      ; New hide/show data added by G-Dubs
	db POKEMON_TOWER_7F, POKEMONTOWER7F_ROCKET2, SHOW      ; New hide/show data added by G-Dubs
	db POKEMON_TOWER_7F, POKEMONTOWER7F_ROCKET3, SHOW      ; New hide/show data added by G-Dubs
	db POKEMON_TOWER_7F, POKEMONTOWER7F_ROCKET4, SHOW      ; New hide/show data added by G-Dubs
...
;	db MT_MOON_1F, MTMOON1F_POTION2,      SHOW   ; Hide/show data removed by G-Dubs
