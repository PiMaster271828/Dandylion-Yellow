...
; Cerulean City
    db $FF, 18, PIDGEOTTO, 15, RATTATA, 18, SPEAROW, 15, ABRA, 15, SANDSHREW, 17, EEVEE, 0         ; Rival 1 3             ; Pidgeotto, Spearow, & Abra added by G-Dubs 
   ;db $FF, 18, SPEAROW, 15, SANDSHREW, 15, RATTATA, 17, EEVEE, 0	; Rival 1 Team 3

ProfOakData:
; Unused
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, BLASTOISE, 70, GYARADOS, 0	               ; Prof. Oak Blastoise 1  
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, VENUSAUR, 70, GYARADOS, 0	               ; Prof. Oak Venusaur  2
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, CHARIZARD, 70, GYARADOS, 0	               ; Prof. Oak Charizard 3
...
Rival2Data:
; SS Anne 2F
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 19, SPEAROW, 18, KADABRA, 19, SANDSHREW, 22, EEVEE, 0	   ; Rival 2 1              ; Pidgeotto, Raticate, & Kadabra added by G-Dubs 
; Pokémon Tower 2F
	db $FF, 28, FEAROW, 26, SANDSLASH, 26, KADABRA, 25, GYARADOS, 25, VULPIX, 30, EEVEE, 0         ; Rival 2 Jolteon  2     ; Sandslash, Kadabra, & Gyarados added by G-Dubs
	db $FF, 28, FEAROW, 26, SANDSLASH, 26, KADABRA, 25, MAGNEMITE, 25, GYARADOS, 30, EEVEE, 0      ; Rival 2 Flareon  2     ; Sandslash, Kadabra, & Gyarados added by G-Dubs
	db $FF, 28, FEAROW, 26, SANDSLASH, 26, KADABRA, 25, VULPIX, 22, MAGNEMITE, 30, EEVEE, 0	       ; Rival 2 Vaporeon 2     ; Sandslash, & Kadabra added by G-Dubs
; Silph Co. 7F
	db $FF, 38, SANDSLASH, 37, PIDGEOT, 35, NINETALES, 36, CLOYSTER, 37, KADABRA, 40, JOLTEON, 0   ; Rival 2 Jolteon  3     ; Pidgeot added by G-Dubs
	db $FF, 38, SANDSLASH, 37, PIDGEOT, 35, CLOYSTER, 36, MAGNETON, 37, KADABRA, 40, FLAREON, 0    ; Rival 2 Flareon  3     ; Pidgeot added by G-Dubs
	db $FF, 38, SANDSLASH, 37, PIDGEOT, 35, MAGNETON, 36, NINETALES, 37, KADABRA, 40, VAPOREON, 0  ; Rival 2 Vaporeon 3     ; Pidgeot added by G-Dubs
; Route 22
	db $FF, 47, SANDSLASH, 45, EXEGGCUTE, 45, NINETALES, 47, CLOYSTER, 50, KADABRA, 53, JOLTEON, 0   ; Rival 2 Jolteon  4
	db $FF, 47, SANDSLASH, 45, EXEGGCUTE, 45, CLOYSTER, 47, MAGNETON, 50, KADABRA, 53, FLAREON, 0    ; Rival 2 Flareon  4
	db $FF, 47, SANDSLASH, 45, EXEGGCUTE, 45, MAGNETON, 47, NINETALES, 50, KADABRA, 53, VAPOREON, 0  ; Rival 2 Vaporeon 4

Rival3Data:
; Champion's Room
	db $FF, 61, SANDSLASH, 59, ALAKAZAM, 61, EXEGGUTOR, 61, CLOYSTER, 63, NINETALES, 65, JOLTEON, 0   ; Rival 2 Jolteon  5
	db $FF, 61, SANDSLASH, 59, ALAKAZAM, 61, EXEGGUTOR, 61, MAGNETON, 63, CLOYSTER, 65, FLAREON, 0    ; Rival 2 Flareon  5
	db $FF, 61, SANDSLASH, 59, ALAKAZAM, 61, EXEGGUTOR, 61, NINETALES, 63, MAGNETON, 65, VAPOREON, 0  ; Rival 2 Vaporeon 5
