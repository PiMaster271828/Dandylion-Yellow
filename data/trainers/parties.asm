...
; Route 22
    db $FF, 9, PIDGEY, 8, RATTATA, 9, EEVEE, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 19, SPEAROW, 16, RATTATA, 18, SANDSHREW, 20, EEVEE, 0	; Rival2 Team 1
; Pokémon Tower 2F
	db $FF, 25, FEAROW, 23, SHELLDER, 22, VULPIX, 20, SANDSHREW, 25, EEVEE, 0	; Rival2 Team 2
	db $FF, 25, FEAROW, 23, MAGNEMITE, 22, SHELLDER, 20, SANDSHREW, 25, EEVEE, 0	; Rival2 Team 3
	db $FF, 25, FEAROW, 23, VULPIX, 22, MAGNEMITE, 20, SANDSHREW, 25, EEVEE, 0	; Rival2 Team 4
; Silph Co. 7F
	db $FF, 38, SANDSLASH, 35, NINETALES, 37, CLOYSTER, 35, KADABRA, 40, JOLTEON, 0	; Rival2 Team 5
