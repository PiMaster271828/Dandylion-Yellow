TrainerAIPointers:
	...
	dbw 2, CooltrainerFAI    ; Cooltrainer ♀     ; Cooltrainer ♀ might switch PokéMon    ; Cooltrainer ♀ uses Hyper Potions 
	dbw 2, BrunoAI           ; Bruno                                                     ; Bruno uses X Defends
	dbw 5, BrockAI           ; Brock                                                     ; Brock uses Full Heals
	dbw 2, MistyAI           ; Misty                                                     ; Misty uses X Defends
	dbw 2, LtSurgeAI         ; Surge                                                     ; Lt. Surge uses X Speeds
	dbw 2, ErikaAI           ; Erika                                                     ; Erika uses Super Potions 
	dbw 2, KogaAI            ; Koga                                                      ; Koga uses X Attacks
	dbw 2, BlaineAI          ; Blaine                                                    ; Blaine uses Hyper Potions
	dbw 2, SabrinaAI         ; Sabrina                                                   ; Sabrina uses X Defends
	dbw 1, LanceAI           ; Gentleman                                                 ; Gentleman uses Max Potions
	dbw 1, Rival2AI          ; Rival 2                                                   ; Rival 2 uses Potions
	dbw 2, Rival3AI          ; Rival 3                                                   ; Rival 3 uses Full Restores
	...
	dbw 3, LanceAI           ; Lance                                                     ; Lance uses Max Potions
	...
	dbw 1, Rival3AI          ; Lady				 ; New trainer class added by G-Dubs     ; Lady uses Full Restores
   ...
   ;dbw 5, Rival3AI          ; Nurse Joy		 ; New trainer class added by G-Dubs     ; Nurse Joy uses Full Restores
