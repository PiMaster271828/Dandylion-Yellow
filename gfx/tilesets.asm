...
CityTileset_GFX::   INCBIN "gfx/tilesets/vermilion_city.2bpp"             ; New tileset added by G-Dubs
CityTileset_Block:: INCBIN "gfx/blocksets/vermilion_city.bst"             ; New blockset added by G-Dubs